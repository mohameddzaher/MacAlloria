    ...
    <header className="w-full z-50">
      ...
      <div className="bg-gray-800 text-white flex justify-evenly items-center px-4 py-2 text-xs fixed top-0 z-50 w-full">
        ...
        <div className="flex gap-3 text-sm">
          <a className="pr-3 hover:text-red-300" href="https://www.facebook.com/mohamed.zaher.589100/" target="_blank" rel="noopener noreferrer">
            <FaFacebook />
          </a>
          <a className="pr-3 hover:text-red-300" href="https://www.instagram.com/mohamedd.zaher/" target="_blank" rel="noopener noreferrer">
            <FaInstagram />
          </a>
          <a className="hover:text-red-300" href="#" target="_blank" rel="noopener noreferrer">
            <FaTiktok />
          </a>
        </div>
      </div>
      ...
      <div className="flex justify-evenly items-center w-full fixed top-8 z-50 bg-white shadow-sm px-6 py-2">
        <div className="w-1/3 flex items-center gap-2 text-red-500 text-xl tracking-widest ">
          <img src={logo} alt="Macalloria Logo" className="w-40 h-12 object-contain cursor-pointer scale-140" />
        </div>
